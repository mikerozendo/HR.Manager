...
public class GetEmployeeByIdRequestHandler(IEmployeeRepository employeeRepository) : IRequestHandler<GetEmployeeByIdRequest, ObjectResult>
{
    public async Task<ObjectResult> Handle(GetEmployeeByIdRequest request, CancellationToken cancellationToken)
	{
		...
		if (employee == null)
		{
			return new  NotFoundObjectResult("The pserson was not found");
		}
