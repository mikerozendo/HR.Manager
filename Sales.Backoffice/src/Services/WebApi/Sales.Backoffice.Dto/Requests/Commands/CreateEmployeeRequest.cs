...
public class CreateEmployeeRequest : IRequest<ObjectResult>
{
    ...
    [Required] public List<CreateDocumentRequest> DocumentList { get; set; } = [];

    [Required] public DateTime BirthDate { get; set; }

    [Required] public DateTime ContractStart { get; set; }

    [Required] public SexTypeDto SexType { get; set; }

    [Required] public List<CreatePersonContactListRequest>? PersonContactList { get; set; } = [];
